...
/**
 *  本方法 主要为了解决 服务器图片更换后，链接地址不变，这样本地缓存也不会刷新，就导致了 bug
 *
 *  @param url
 *  @param placeholder
 *  @param options
 */
- (void)sd_specialImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options;
